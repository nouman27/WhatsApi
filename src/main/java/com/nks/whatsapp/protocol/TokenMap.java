...
public static Object[] tryGetToken(String input, boolean subdict, int token)
{
    int index=Util.array_search(input, primaryStrings);
    if (index>0) {
    	return new Object[]{index,subdict,true};
    }
   index = Util.array_search(input,secondaryStrings);
    if (index>0) {
    	return new Object[]{index,true,true};
    }
    return new Object[]{token,subdict,false};
}
